...
$sql    = "SELECT * FROM dt_power_reading ORDER BY power_reading_id DESC LIMIT 10";
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
              ...
              <a class="d-flex align-items-center text-muted" href="https://getbootstrap.com/docs/4.1/examples/dashboard/#">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              <thead>
				...
				<tr>
				<td> <?PHP  echo $sense['grid_amp']     ;       ?> A     </td>
				<td> <?PHP  echo $sense['grid_volt']    ; 	    ?> V     </td>
				<td> <?PHP  echo $sense['grid_kwh']     ;       ?> KW/h  </td>
				<td> <?PHP  echo $sense['grid_kwh']     ;       ?> KW/h  </td>
				<td> <?PHP  echo date('H:i:s', $time);    ?>
				<?PHP 
	   
				array_push($dataPoints, array('x' =>  $time, 
											  'y' => floatval($sense['grid_kwh'])));
				$i++; if($i == 5) break;	
				}              
