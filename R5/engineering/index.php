...
<!--               <a class="nav-link" href="https://getbootstrap.com/docs/4.1/examples/sticky-footer-navbar/#">Home <span class="sr-only">(current)</span></a> -->
          ...
          <ul class="navbar-nav mr-auto">
         <li class="nav-item active">
              <a class="nav-link" href="../engineering/index.php">Home <span class="sr-only"></span></a>
            </li>
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item">
           <a href="#dolor" class="nav-link " data-toggle="tab" role="tab" aria-controls="dolor">inventory List</a>
            ...
            <li class="nav-item">
           <a href="#dolor" class="nav-link " data-toggle="tab" role="tab" aria-controls="dolor">FUNGSI SELANJUTNYA DISINI</a>
      </li>
    </ul>
  </li>
</ul>
...
<table class="table table-bordered">
    ...
    <?PHP while($list3  = mysqli_fetch_array($inventory_result)) { //Inventory_list ?>
        ...
        <td><center><?PHP echo $list3['tambah']        ?></center></td>
        <td><center><?PHP echo $list3['kurang']        ?></center></td>
    </tr><?PHP } ?>
    </tbody>
  </table>
		</div>
